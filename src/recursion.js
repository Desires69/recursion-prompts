...
var arraySum = function (arr) {
  ...
  if (Array.isArray(arr[0])) return arraySum(arr[0]) + arraySum(arr.slice(1, arr.length));
...
/**
 * ALTERNATE VERSION. FLOATING POINT ERROR
 var exponent = function (base, exp) {
  if (!exp) return 1;
...
var palindrome = function(string) {
  ...
  if ((string[0] === string[string.length - 1]) || (string[0] === ' ' || string[string.length - 1] === ' ')) return palindrome(string.slice(1, -1));
  return false;
};
